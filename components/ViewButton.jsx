...
const ViewButton = ({ name, url }) => {
    return (
        ...
        >
            ...
            >
                <div className="bg-[#d7d9fd] flex items-center gap-1 p-2 rounded-md">
                    <svg
                        fill="none"
                        viewBox="0 0 24 24"
                        height="20px"
                ...
                <div
                    className="shadow-md bg-[#d7d9fd] absolute bottom-0 translate-y-1/2 left-1/2 translate-x-full rotate-45 p-1"
                ></div>
                <div
            ...
            <div
                className="shadow-md flex items-center group-hover:gap-2 bg-gradient-to-br from-[#d7d9fd] to-[#d7d9fd] p-3 rounded-full cursor-pointer duration-300"
            >
                <svg
                    fill="none"
                    viewBox="0 0 24 24"
